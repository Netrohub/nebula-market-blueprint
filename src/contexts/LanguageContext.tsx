...
const translations = {
  ...
  ar: {
    ...
    itemsSavedForLater: 'عناصر محفوظة لوقت لاحق',
    addAllToCart: 'إضافة الكل إلى السلة',
    clearWishlist: 'مسح قائمة الأمنيات',
    yourWishlistIsEmpty: 'قائمة أمنياتك فارغة',
    startAddingProducts: 'ابدأ بإضافة المنتجات التي تحبها لتتبعها!',

    // Checkout Page
    checkout: 'الدفع',
    completePurchaseSecurely: 'أكمل عملية الشراء بشكل آمن',
    contactInformation: 'معلومات الاتصال',
    paymentMethod: 'طريقة الدفع',
    creditDebitCard: 'بطاقة الائتمان / الخصم',
    payWithCard: 'ادفع ببطاقتك',
